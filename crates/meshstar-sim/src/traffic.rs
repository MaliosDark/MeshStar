...
pub struct TrafficParams {
    ...
    pub sinks: usize,
    /// Partners per node for the `Partners` pattern.
    pub partners: usize,
...
impl Default for TrafficParams {
    fn default() -> Self {
        Self { pattern: TrafficPattern::Partners, messages_per_minute: 6.0, payload_bytes: 40, reliability: Reliability::Acknowledged, broadcast_fraction: 0.0, sinks: 3, partners: 2, drain_s: 120 }
    }
}
...
impl TrafficGen {
    pub fn new(params: TrafficParams, start_ms: u64, end_ms: u64) -> Self {
        ...
        Self { params, start_ms, stop_ms, next_at: start_ms, generated: 0, leaves: Vec::new(), always_on: Vec::new(), partner_table: Vec::new() }
    }
